...
endQdate = "2020-12-3"
siteQcode = "01481000" #01481000 for BAM and 01481500 for Wlibrary(dataRetrieval)#check station code online (usually an 8-15 digit numebr)
...
Daily_Temp = BAM_q[,3:4]; colnames(Qtemp)<-c("date","Temperature")
