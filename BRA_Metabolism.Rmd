...
write.csv(Met_data_original,"C:/Users/mpeipoch/Dropbox/manuscripts/RiverPlankton/working_files/temp.csv")
Met_data_original = read.csv("C:/Users/mpeipoch/Dropbox/manuscripts/RiverPlankton/working_files/temp.csv")

Met_data_original$date = as.POSIXct(Met_data_original$date, format="%m/%d/%Y %H:%M", tz='America/New_York')
