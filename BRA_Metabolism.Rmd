...
#add miniDOT DO data
miniDOTdata = read.csv("C:/Users/mpeipoch/Dropbox/manuscripts/RiverPlankton/working_files/miniDOT_BAM.csv")
...
PARdata = read.csv("C:/Users/mpeipoch/Dropbox/manuscripts/RiverPlankton/working_files/PARdata_smt.csv")
...
Met_data2 = Met_data[-c(2160:2190),]
```

Visualization of raw data to ensure data input is allright
```{r}
...
```{r}
mle_BRA <- mm_name(type='mle')
mle_specs <- specs(mle_BRA, init.GPP.daily= 4,init.ER.daily = -2,init.K600.daily = 2  )
