...
```{r}
input_directory = "~/Dropbox/COVID_TempDirectories/BrandywineSeston"
output_directory = "~/Dropbox/manuscripts/RiverPlankton/working_files"
aggregfile = "BRA_WILMA_Chl_Oct2020.csv"
new_aggregfile = "BRA_WILMA_Chl_Oct2020.csv"
...
lastfile = "WILMArawCSV2.csv"
startQdate = "2019-06-01"
endQdate = "2020-11-26"
...
dataset.15min <- right_join(dataset.15min,QTurb,by = "date") #15min averaged dataset
